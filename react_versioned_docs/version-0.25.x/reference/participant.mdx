...
| setOverlay   | overlay: ReactNode \| HTMLElement   | Set an overlay on the participant video (see [video overlays](./../customize-meeting-ui#add-overlay--filter-to-meeting-video) for more details)                                                |
...
| setLabel     | label: string                       | Sets a label against the participant in the Participant list                                                                                                                                   |
