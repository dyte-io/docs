...
You can get a list of all participants in the meeting using the `participants` property of `DyteMeeting`.
...
```objectivec
NSArray *participants = meeting.participants;
```
