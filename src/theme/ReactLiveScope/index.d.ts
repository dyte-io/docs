...
declare const ReactLiveScope: {
  ...
  createElement(
    ...
    HTMLInputElement
  >;
  createElement<P_5 extends React.HTMLAttributes<T_3>, T_3 extends HTMLElement>(
    type: keyof React.ReactHTML,
  ...
  cloneElement<P_12 extends React.HTMLAttributes<T_7>, T_7 extends HTMLElement>(
    element: React.DetailedReactHTMLElement<P_12, T_7>,
    props?: P_12 | undefined,
    ...children: React.ReactNode[]
  ): React.DetailedReactHTMLElement<P_12, T_7>;
  cloneElement<P_13 extends React.HTMLAttributes<T_8>, T_8 extends HTMLElement>(
