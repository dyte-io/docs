...
A webhook enables Dyte to push real-time updates to your application. Dyte uses
HTTPS to send events to your webhook endpoint as a JSON payload. You can then
use these events to perform actions in your backend systems. To learn more, see
Dyte webhook events overview.
