...
<head>
  ...
  <meta name="description" content="Discover how to effectively work with plugin stores using the Dyte Plugin SDK. Customize and distribute your plugins seamlessly.">
</head>
