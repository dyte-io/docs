...
Dyte also allows you to publish multiple versions of your Plugin SDK. The [Dyte CLI](https://docs.dyte.io/cli) can be used to update the versions. Once you've published a plugin, it's ready to use.
