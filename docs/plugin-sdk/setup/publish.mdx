...
<head>
  ...
  <meta name="description" content="Guide on how to publish your plugin setup using the Dyte Plugin SDK. Ensure a seamless deployment and distribution process for your plugins.">
</head>
