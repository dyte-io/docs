...
Once you've published a plugin, it's ready to use.

Dyte also allows you to keep multiple versions of your Plugin SDKs. The Dyte CLI can be used to manage the versions.
