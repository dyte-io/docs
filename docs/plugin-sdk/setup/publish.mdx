...
Dyte also allows you to publish multiple versions of your Plugin SDKs. The Dyte CLI can be used to update the versions. Once you've published a plugin, it's ready to use.
...
2. If you want to publish a new version, update the version in `dyte-config.json`. We advice using semantic versioning.
