...
<head>
  ...
  <meta name="description" content="Learn the basic methods of using Dyte Plugin SDK for efficient integration. Enhance your app's functionality with powerful plugin methods.">
</head>
