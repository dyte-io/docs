...
sidebar_position: 1
description: >-
  Initialize your plugin with Dyte Plugin SDK using our basic usage guide.
...
<head>
  ...
  <meta name="description" content="Initialize your plugin with Dyte Plugin SDK using our basic usage guide. Ensure a smooth start to your plugin integration process.">
</head>
