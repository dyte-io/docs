...
A new poll can be created using the `create` method from the [`meeting.polls`](./introduction) object. The `meeting.polls.create()` method accepts the following params.
