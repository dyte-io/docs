...
[Flutter UI Kit Sample App GitHub repository](https://github.com/dyte-in/sample-android-ui-kit).
...
Set `compileSdkVersion 33` & `minSdkVersion 21` inside `build.gradle` file of android.

:::

## Step 2: Initialize the SDK

The `DyteUIKit` is the main class of the SDK. It is the entry point and
...
Set the properties in the `DyteMeetingInfo` class. You just need to provide
