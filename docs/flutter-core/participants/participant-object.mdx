...
The `DyteMeetingParticipant` object consists of all the information related to a particular
...
- `clientSpecificId`: Arbitrary ID that can be set to identify the
  participant.
