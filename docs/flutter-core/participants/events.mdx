...
method. Here are the supported methods:
...
- <span style={{ fontSize: '1em', fontWeight: 'bold' }}>
    onActiveParticipantsChanged(`required List DyteMeetingParticipant
    activeParticipants)
  </span>
  : Triggered when active participants changes to <code>activeParticipants</code>
