...
@override
void onParticipantScreenShareStarted(DyteJoinedMeetingParticipant participant) {
  /// handle screen share started of `DyteJoinedMeetingParticipant` participant
}

@override
void onParticipantScreenShareEnded(DyteJoinedMeetingParticipant participant) {
...
- <span style={{ fontSize: '1em', fontWeight: 'bold' }}>
    onActiveSpeakerChanged(DyteJoinedMeetingParticipant participant)
  </span>
...
- <span style={{ fontSize: '1em', fontWeight: 'bold' }}>
    onParticipantPinned(DyteJoinedMeetingParticipant participant)
  </span>
  : Triggered when the <code>participant</code> is pinned.
- <span style={{ fontSize: '1em', fontWeight: 'bold' }}>
    onParticipantUnpinned(DyteJoinedMeetingParticipant participant)
  </span>
