...
Call this method to request host to join stage. Ensure that the participant has the required (preset permissions)[https://docs.dyte.io/guides/livestream/advanced/configuring-permissions].
...
[_String?_]: Returns the url of the livestream.

### getRoomName()

[_String?_]: Returns the name of the room.

### getState()

[_DyteLivestreamStatus?_]: Returns the current status of the livestream.<br /><br />
