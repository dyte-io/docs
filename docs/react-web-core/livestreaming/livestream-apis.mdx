...
**playbackUrl**: This URL allows you to watch the live video stream. It is the location of the video file and can be accessed by a HLS/LHLS player.
...
**viewerCount**: The number of people viewing the livestream.
