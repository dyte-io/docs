...
Dyte provides the following four prebuilt presets. These presets come with predefined permissions and UI configurations.
...
| Mute Audio                         | Host can mute/unmute individual participants or all of them at once.                                                                                                                |
