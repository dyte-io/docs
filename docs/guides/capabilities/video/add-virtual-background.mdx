...
2.x versions of DyteVideoBackgroundTransformer use their own rendering mechanisam thus require you to disable the default per frame canvas rendering.
...
<head>
  ...
  <meta name="description" content="Learn how to add virtual backgrounds with Dyte's customization capabilities. Follow our guide for effective customization of virtual backgrounds."/>
</head>
