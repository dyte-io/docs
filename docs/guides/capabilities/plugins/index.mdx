...
Plugin-SDK is currently in beta. To use this SDK, please contact support@dyte.io

:::

If existing plugins don't meet your requirements, you can create your own plugins using Dyte's Plugin SDK which includes Meeting APIs and a built-in realtime database.
...
Check out the guides below to use the Plugin-SDK:

<CardSection id="new-plugins">
  <Card
    title="Create a plugin"
    to="/plugin-sdk/setup/create"
    description="Learn to use the Dyte CLI to create a new plugin"
  />
  <Card
    title="Publish plugin"
    to="/plugin-sdk/setup/publish"
    description="Learn to build and publish the plugin"
  />
  <Card
    title="Meeting APIs for plugin"
    to="/plugin-sdk/usage/rooms-api/methods"
    description="Learn to use the Meeting APIs to align your plugin with the meeting"
  />
  <Card
    title="Realtime Data Store for plugin"
    to="/plugin-sdk/usage/stores-api/introduction"
    description="Learn to leverage the temporary realtime database to manage your data better"
  />
</CardSection>
