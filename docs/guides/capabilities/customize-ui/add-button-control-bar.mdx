...
<head>
  <title>Add a Custom Button to the Control Bar Guide</title>
  <meta name="description" content="Learn how to add a control bar button with Dyte's customization features. Follow our guide for effective customization of your control bar."/>
</head>
