...
1. [Getting started with Polls](./getting_started) walks through creating polls from the coreSDK

2. [Integrating UIKit for Polls](./uikit) helps understand the UI components that can be used to make integrating polls even easier
