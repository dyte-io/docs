...
<head>
  ...
  <meta name="description" content="Explore various webhook events and their implementation with Dyte's capabilities. Follow our guide for effective event handling."/>
</head>
