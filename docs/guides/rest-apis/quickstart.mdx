...
<head>
  ...
  <meta name="description" content="Get started with Dyte's REST APIs. Follow our guide for a quickstart on using REST APIs for seamless integration and development.">
</head>
