...
<head>
  ...
  <meta name="description" content="Explore the migration guide for transitioning to Dyte's V2. Follow our guide for effective migration strategies and implementation.">
</head>
