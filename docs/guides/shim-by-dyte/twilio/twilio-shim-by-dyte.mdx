...
## Getting started with Twilio Shim
...
Here are some sample cases, and if you want to see a complete list of compatible features, see the [Twilio Shim: Supported Features](/guides/shim-by-dyte/twilio/compatibility-shim-twilio) page.
