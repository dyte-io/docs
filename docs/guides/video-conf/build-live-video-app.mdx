...
Presets](/guides/presets/add-presets).
...
This step includes first installing the SDK and then initializing the frontend SDKs using the authentication `token`.

Refer to the web and mobile quickstart guides to view the code samples and get started with your preferred SDK.
...
Your fully functional meeting will look something like this:

<img
  src="/static/guides/create-live-video-apps1.png"
  width="900"
  height="600"
  alt="create-live-video-apps"
  className="create-live-video-applications"
/>
