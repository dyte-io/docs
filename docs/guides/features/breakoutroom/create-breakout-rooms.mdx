...
- For hosts ensure that you’ve created a preset with the Full Access permissions. See [hosts permissions](/guides/features/breakoutroom/create-breakout-rooms#host).
- For participants you’ve created a preset with Switch to Parent Meeting and/or Switch Connected Meetings permissions. See [participants permissions](/guides/features/breakoutroom/create-breakout-rooms#participants).
