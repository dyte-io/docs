...
- Setting up webhook for the [meeting.chatSynced](/guides/integrate-core-features/webhooks/webhook-events#meetingchatsynced) event

This guide walks you through the steps involved in exporting chat dump of a session using Chat Replay API.

If you wish to use webhooks, see [Set Up Webhooks](/guides/integrate-core-features/webhooks/webhooks-and-events) and [meeting.chatSynced](/guides/integrate-core-features/webhooks/webhook-events#meetingchatsynced).
