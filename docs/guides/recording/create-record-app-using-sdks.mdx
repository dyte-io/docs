...
| `options.autoStart (boolean)`   | Set to true if you want to manually call the `startRecording` function.                                                                                                                                                                                                                                                                                                                                                                                                         |
...
Call `init` after creating the meeting object.
...
To manually start the recording, call the `startRecording()` function. For example, you want to start a recording after you have loaded your UI content in the app and recordOnInit is not set to true. In such cases, you can manually call the startRecording() function when you are ready to begin the recording.
