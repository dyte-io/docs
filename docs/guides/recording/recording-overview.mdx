...
- **Webhook**: Utilize the [`recording.statusUpdate`](/guides/webhooks/webhook-events#recordingstatusupdate) webhook to receive real-time updates about the status of your recordings.
