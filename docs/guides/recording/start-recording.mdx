...
specify the `record_on_start` parameter to start the recording as soon as the
meeting starts.

:::info note

If you’re using this method to start the recording, you will need to specify the
