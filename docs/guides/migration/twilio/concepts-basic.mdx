...
To access Twilio's API, you need an Account SID and Auth Token which can be obtained from `console.twilio.com`. Dyte uses Organization ID and API Key that you can get from the [Developer Portal](dev.dyte.io).
