...
- [Add participants](/api#/operations/add_participant) to the meeting with the required [presets](/guides/livestream/getting-started-with-livestreaming#step-2-create-presets)
