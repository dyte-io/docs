...
There are two ways to start livestreaming a Dyte meeting:

- Using the [Start livestreaming a meeting](/api#/paths/meetings-meeting_id--livestreams/post) API
- Start the livestream directly from the meeting user interface (UI)
  - Click on the **Go live** button on the control bar to start livestreaming a meeting.
...
- [Livestream a Dyte meeting via HLS](/guides/livestream/interactive-livestream/livestream-dyte-meeting)
- [Livestream Dyte meetings to other platforms](/guides/livestream/interactive-livestream/livestreaming-other-platforms)
- [Livestream any video via RTMP (custom input)](/guides/livestream/livestream-rtmp-input/livestream-any-rtmp)
