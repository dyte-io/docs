...
[Create a meeting API](/api/?v=v2#/operations/create_meeting) API.
...
Alternatively, you also have the option to start the livestream directly [from the UI](/guides/livestream/interactive-livestream/getting-started-with-livestreaming#from-the-meeting-ui). However, ensure that you've added all the viewers using the Add participant API with the required [presets](/guides/livestream/interactive-livestream/getting-started-with-livestreaming#step-2-create-presets).
