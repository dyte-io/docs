...
Use the [Start livestreaming a meeting](/api#/paths/meetings-meeting_id--livestreams/post) API or click on the **Go live** button on the control bar to start livestreaming a meeting.
