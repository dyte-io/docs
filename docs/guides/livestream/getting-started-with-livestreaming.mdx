...
This document takes you through the steps to set up your first Dyte interactive livestream (ILS).
...
| Disable Video                      | Hosts can hide video of individual participants or all of them at once.                                                                                                             |
...
| Update Participant Preset          | Update participant permissions / meeting type dynamically.                                                                                                                          |
...
| **Permissions and Configurations**               | **Description**                                                                       |
| ------------------------------------------------ | ------------------------------------------------------------------------------------- |
| Start Livestream                                 | Adds permissions to start livestreaming your meeting.                                 |
| Admit or remove participants from the livestream | Allows to admit or remove participants from the livestream.                           |
