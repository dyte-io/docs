...
You can use [webhooks](/guides/integrate-core-features/webhooks/webhooks-overview) to notify your application when the status of a livestream changes, such as when it is live or offline.

## Configure a webhook

As a first step, you'll have to set up a webhook to receive real-time updates for your livestream.

For the detailed steps on how to set up a webhook, see [Set Up Webhooks ](/guides/integrate-core-features/webhooks/webhooks-and-events).
