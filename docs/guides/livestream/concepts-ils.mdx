...
This topic covers essential concepts related to Dyte's interactive live streaming (ILS). For the concepts related to live video applications, see [Video Conferencing concepts](/guides/video-conf/concepts-live-video).
...
For more information, see [Livestream any custom video input](/guides/livestream/livestream-any-rtmp).
