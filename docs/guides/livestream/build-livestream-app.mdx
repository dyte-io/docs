...
<IntegrateDyte
  ...
  savePresetInfo={
    <Admonition type="info">
      <p>
        It is important to understand that you need to create two presets for
        livestreaming. One preset is used for the livestreaming <b>host</b> and
        the other preset is used for the livestreaming <b>viewer</b>.
      </p>
      <p>
