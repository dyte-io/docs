...
| playback_url   | The playback URL is the web address that viewers can use to watch the live stream. Viewers can enter the playback URL into their web browser or use a media player that supports RTMP streaming to watch the live stream.                                                                                                                                                                                                                                                                                                                                                            |
