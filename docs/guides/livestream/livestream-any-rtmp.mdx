...
Using the livestream ID that you generated in the previous [step](/guides/livestream/livestream-any-rtmp#step-2-generate-credentials-for-a-livestream), you can fetch details of
livestream.
