...
## Step 3: Specify RTMP ingestion URL for livestreaming

In your application, enter the ingestion URL you generated in the previous [step](/guides/livestream/livestream-rtmp-input/livestream-any-rtmp#step-2-generate-credentials-for-a-livestream).
...
Using the livestream ID that you generated in the previous [step](/guides/livestream/livestream-rtmp-input/livestream-any-rtmp#step-2-generate-credentials-for-a-livestream), you can fetch details of
livestream.
