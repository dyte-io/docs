...
<head>
  ...
  <meta name="description" content="Learn how to build an in-app chat experience with Dyte's realtime chat capabilities. Follow our guide for effective in-app chat development.">
</head>
