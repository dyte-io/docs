...
- Dyte provides prebuilt presets for webinar presenters and viewers, offering predefined permissions and UI configurations tailored to their roles. For more information, see [Add Presets](/guides/presets/add-presets).
...
- Dyte provides prebuilt presets specifically designed for group calls, including the `group_call_host` and `group_call_participant` presets, which offer predefined permissions and UI configurations for hosts and participants. For more information, see [Add Presets](/guides/presets/add-presets).

## Key features of a Dyte's webinar

The following are some of the highlights of Dyte's webinar:

- Manage permissions for hosts and participants using [presets](/guides/presets/add-presets) to control stage access.
