...
This event is fired 2 seconds after all the participants leave the meeting. We add a 2-second delay to make sure we don't end a meeting due to disconnects.
