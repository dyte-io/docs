...
2. Dyte generates a downloadable link from which the recording can be
   ...
   - Using the
     [`recording.statusUpdate`](/guides/integrate-core-features/webhooks/webhook-events#recordingstatusupdate)
...
- **Webhook**: Utilize the [`recording.statusUpdate`](/guides/integrate-core-features/webhooks/webhook-events#recordingstatusupdate) webhook to receive real-time updates about the status of your recordings.
