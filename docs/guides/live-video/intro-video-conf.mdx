...
- **Virtual background**: You can add custom virtual background to Dyte video calls. See [Add Custom Virtual Background to Dyte meetings](/guides/capabilities/video/add-virtual-background).
