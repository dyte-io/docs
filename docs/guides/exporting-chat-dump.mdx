...
Chat Replay API is not enabled by default for your organization. [Contact Us](https://dyte.io/contact) to enable the Chat Replay API for your organziation.

:::

Once [Chat Replay API](/api/?v=v2#/operations/GetSessionChat) is enabled, do the following:
