...
| setOverlay   | overlay: ReactNode                  | Set an overlay on the participant video (see [video overlays](./../customize-meeting-ui#add-overlay--filter-to-meeting-video) for more details)                                                |
