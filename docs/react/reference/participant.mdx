...
| setOverlay   | overlay: ReactNode                  | Set an overlay on the participant video (see [Video overlays](doc:overlays#participant-video-overlay) for more details)                                                                        |
| sendMessage  | message: any                        | Send custom event to the participant                                                                                                                                                           |
