...
Being a subclass of DyteParticipant, all the properties and methods of DyteParticipant are available to DyteSelfParticipant. Other than that, it exposes a few special properties and methods.
...
| disableScreenshare |                         | Disable screen sharing from the participant to the meetin       |
