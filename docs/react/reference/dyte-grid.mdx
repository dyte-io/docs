...
| setOverlay  | element: ReactNode \| HTMLElement     | Set an overlay / filter on the entire meeting grid, read more about [this in the usage section](./../usage#add-overlay-to-meeting-video) |
