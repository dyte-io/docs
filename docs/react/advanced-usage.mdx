...
```javascript
let version = DyteMeeting.version;
```
...
!['react' button added to the control bar](/static/react/react-control-bar.png)
...
!['react' button added to the context menu](/static/react/react-context-menu.png)
