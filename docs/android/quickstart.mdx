...
[Android UI Kit Sample App GitHub repository](https://github.com/dyte-in/sample-android-ui-kit).
...
If you intend to publish your app to the Google Play, you'll need
...
If you intend to publish your app to the Google Play, perform the
