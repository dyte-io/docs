...
The `DyteMeeting` component contains all the necessary features and subcomponents to create a default meeting UI.
...
In order to replace Dyte's default icon set with your own, you can pass the link to your icon set in the `DyteMeeting` component as the following:
