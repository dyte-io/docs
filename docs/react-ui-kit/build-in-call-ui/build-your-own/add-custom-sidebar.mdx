...
Complete code sample link: https://github.com/dyte-io/react-samples/tree/main/samples/create-your-own-ui
...
Let's say, we want to build a proctoring solution and for that we want to show guidelines to the participant in a side bar, to warn the participant not to cheat. To do so, in the below code snippet, we have added `warnings` sidebar section.
...
For such extensions, we will have to update the types as well if in case you are using react with Typescript.
