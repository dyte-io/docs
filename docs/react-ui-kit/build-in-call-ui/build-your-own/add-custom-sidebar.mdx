...
Considering a proctoring solution, in the above code snippet, we have added `warnings` sidebar section.

We have added a custom button to trigger the UI as well.
