  ...
  return (
    ...
    >
      ...
      {currentTab === 'participants' && (
        <DyteParticipants meeting={meeting} config={config} states={states} slot="participants" />
      )}
      {currentTab === 'plugins' && <DytePlugins meeting={meeting} config={config} slot="plugins" />}
      {currentTab === 'guidelines' && (
        <div slot="guidelines" className="flex justify-center items-center p-2">
          <div>
    ...
    <div
      ...
      ref={(el) => {
        el?.addEventListener('dyteStateUpdate', (e) => {
          const { detail: newStateUpdate } = e as unknown as {
            detail: CustomStates;
          };
