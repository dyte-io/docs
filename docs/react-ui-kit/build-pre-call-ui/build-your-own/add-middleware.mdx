---
title: Add video background or video blur
sidebar_position: 4
---
            ...
            <div className='flex justify-around w-full h-full p-[10%]'>
                <DyteParticipantTile meeting={meeting} participant={meeting.self}>
                    ...
                    <div id='user-actions' className='absolute flex bottom-2 right-2'>
                        ...
                        <DyteControlbarButton className="cursor-pointer" size="sm" icon={effectsSVG} onClick={() => {
                            ...
                            if (changer) {
                                ...
                                if (changer.shadowRoot?.querySelector('#main')) {
                                    (changer.shadowRoot.querySelector('#main') as any).style.overflow = 'hidden'
                                }
...
With this, we now have the video background changer as well. This adds the ability to blur the background as well.
