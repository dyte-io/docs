...
The control bar displays various controls for online meetings. The control bar can be easily customized to match the branding of your web application. By customizing the control bar, you have the flexibility to show or hide controls, add or remove buttons, and make other adjustments to enhance the meeting experience for your users. It is made up of [DyteControlbarButton](/react-ui-kit/components/dyte-controlbar-button), a skeleton component used for composing buttons.
