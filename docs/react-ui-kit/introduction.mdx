...
- **Use prebuilt components**: You can use prebuilt `DyteMeeting` component to
  ...
  the states, dialogs, and other aspects of managing the application. 
  The UI kit also respect your permissions and theming configuration from the preset.
  
  For more information, see
  [React UI Kit Quickstart](/react-ui-kit/quickstart).
...
- **Build your own UI**: Dyte also offers the flexibility to build your own UI
  ...
  exact needs. See
  [Build your own UI](/react-ui-kit/basics/components-basics).
