...
components. If you're looking at integrating individual UI Kit components into
your UI at different parts, see the Integrate UI Kit Components.
...
- Make sure you've read the [Getting Started with Dyte](/getting-started) topic
  and completed the steps in the
  [Integrate Dyte](/getting-started#integrate-dyte) section before you begin
  integrating Dyte into your application. You must complete the following steps:
...
3. Call the `init()` method and pass the following parameters:

|             |                                                                                                                                                                                   |
| ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `meetingId` | Pass the [meetingId](/api/?v=v2#/operations/create_meeting)                                                                                                                       |
