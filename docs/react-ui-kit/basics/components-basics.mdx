...
props and a `onDyteStateUpdate` callback prop when the state updates
...
<head>
  <title>React UI Kit Components Basics</title>
  <meta name="description" content="Learn the basics of components in React Native with Dyte's comprehensive guide. Understand the fundamental building blocks for React Native applications.">
</head>
