...
You can use the provided `<DyteMeeting />` monolith component in case you want to write less code and not handle all the states and components rendering.
...
- Normal Grid components - `DyteSimpleGrid`, `DyteMixedGrid`, `DyteSpotlightGrid`
