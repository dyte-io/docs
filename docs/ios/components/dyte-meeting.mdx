...
```swift
self.dyteUikit = DyteUiKit.init(meetingInfoV2: DyteMeetingInfoV2(authToken: authToken, enableAudio: false, enableVideo: false, baseUrl: Constants.BASE_URL_INIT), flowDelegate: nil)
