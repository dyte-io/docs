...
specific use cases or events.

Call the `updateUIConfig` method on
[`DyteMeetingView` instance](./reference/dyte-meeting) and pass the
[`uiConfigOptions`](./reference/dyte-ui-config) as an NSDictionary to this call.
