...
- Read the [Introduction to React Native UI Kit](/rn-ui-kit) to understand the UI
...
|                         |                                                                                                                              |
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| @dytesdk/react-native-ui-kit   | 1.2.0
| @dytesdk/react-native-core | 0.3.0
...
[DyteMeeting](/rn-ui-kit/components/dyte-meeting).
