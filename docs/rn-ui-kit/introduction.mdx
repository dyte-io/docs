...
- Includes a number of [Hooks](https://beta.reactjs.org/reference/react). Hooks
  ...
  information, see [Use React Native Core Hooks](/rn-ui-kit/using-hooks).
...
- **Use prebuilt components**: You can use prebuilt `DyteMeeting` component to
  ...
  For more information, see [React Native UI Kit Quickstart](/rn-ui-kit/quickstart).
...
- Dyte UI Kit is built using
  [React Native components](https://reactnative.dev/docs/components-and-apis). React Native Components are a built-in browser specification that enables you to develop reusable custom elements without relying on any third-party frameworks.
- Dyte's React Native UI Kit also provides multiple
  ...
  [Use React Native Core Hooks](/rn-ui-kit/using-hooks).
