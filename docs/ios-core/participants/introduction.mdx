...
<head>
  ...
  <meta name="description" content="Explore the introduction to participants in iOS Core with Dyte Docs. Learn how to enhance your app's collaborative features seamlessly.">
</head>
