...
<head>
  ...
  <meta name="description" content="Explore the process of sending a chat message in iOS Core with Dyte Docs. Empower users to communicate effectively within your app.">
</head>
