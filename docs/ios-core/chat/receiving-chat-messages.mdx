...
<head>
  ...
  <meta name="description" content="Learn how to receive chat messages in iOS Core with Dyte Docs. Enhance your app's communication capabilities with seamless chat integration.">
</head>
