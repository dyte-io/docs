...
To join the stage in a webinar, specific permissions are required, which are managed through [Presets](/guides/features/presets). To determine if you have the necessary permissions, use the following command:
