...
[sample code](https://github.com/dyte-io/mobile-samples/tree/main/iOS-core). You can clone
and run a sample application from the iOS Core SDK GitHub repository.
