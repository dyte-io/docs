...
<head>
  ...
  <meta name="description" content="Learn about local user management in iOS Core with Dyte Docs. Understand the fundamentals for effective integration and app customization.">
</head>
