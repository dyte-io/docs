...
<head>
  ...
  <meta name="description" content="Get introduced to the polls feature in iOS Core with Dyte Docs. Explore how polls can enrich your app's interactive capabilities for users.">
</head>
