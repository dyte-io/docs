...
<head>
  ...
  <meta name="description" content="Discover how to handle waitlist events in iOS Core with Dyte Docs. Optimize your app's performance by effectively managing waitlisted users.">
</head>
