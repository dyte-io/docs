...
<GetStartedCard
  ...
  className="xl:col-span-3 from-[#4B6CB7] to-[#182848]"
...
<GetStartedCard
  ...
  className="xl:col-span-3 from-[#1488CC] to-[#2B32B2]"
  getStartedLink="https://example.com"
  repoLink="https://github.com/dyte-in"
  BGIcon={ReactRevolveIcon}
  bgClassName="rotate-[32deg] right-[-8px] bottom-[-2.25rem]"
...
<GetStartedCard
  ...
  className="xl:col-span-3 bg-gradient-to-rl from-[#CB55C0] to-[#F28E0E]"
  getStartedLink="https://example.com"
  repoLink="https://github.com/dyte-in"
  bgClassName=""
  BGIcon={KotlinIcon}
...
<GetStartedCard
  ...
  className="xl:col-span-3 bg-gradient-to-rl from-[#FF512F] to-[#F09819]"
  getStartedLink="https://example.com"
  repoLink="https://github.com/dyte-in"
  bgClassName=""
  BGIcon={SwiftIcon}
