...
<head>
  ...
  <meta name="description" content="Learn the basics of integrating Dyte's chat functionality into your Android application – a step towards immersive real-time communication.">
</head>
