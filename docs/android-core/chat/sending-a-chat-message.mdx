...
<head>
  <title>Android Core Sending a chat message</title>
  <meta name="description" content="Master the process of sending chat messages within your Android application with Dyte, empowering your users to communicate effortlessly.">
</head>
