[io.dyte.core.meeting.events](../../index.md)/[InboundMeetingEventType](../index.md)/[WEB_SOCKET_CREATE_TRANSPORT](index.md)

# WEB_SOCKET_CREATE_TRANSPORT


[WEB_SOCKET_CREATE_TRANSPORT](index.md)

gets called twice, one to receive and another to transmit
