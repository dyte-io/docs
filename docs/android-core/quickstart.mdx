...
:::info Init meeting event listeners
Once you call `init()`, you can listen to callbacks for this action on meeting object by registering observer as follows.
```kotlin
...
Once you call `joinRoom()`, you can listen to callbacks for this action on meeting object by registering observer as follows.
```kotlin
...
You can listen to `leaveRoom()` callbacks by registering obsever on meeting object as follows
```kotlin
