...
If the local user has the permission to accept waiting room requests (`selfPermissions.host.canAcceptRequests` is true), you can 
manage pending waiting room requests, accepting or rejecting them as needed.
