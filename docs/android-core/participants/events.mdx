...
<head>
  <title>Android Core Participant Events</title>
  <meta name="description" content="Dive into the details of handling participant events in your Android application using Dyte's comprehensive documentation.">
</head>
