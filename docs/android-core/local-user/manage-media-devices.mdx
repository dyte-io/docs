...
To set a device as an active device, you can call `setAudioDevice` method. This takes
a `DyteAudioDevice` object.
...
To set a video device as an active device, you can call `setVideoDevice` method. This takes
a `DyteVideoDevice` object.
